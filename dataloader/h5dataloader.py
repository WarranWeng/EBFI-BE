...
# local modules
from dataloader.h5dataset import H5Dataset
from dataloader.h5dataset_realdata import H5Dataset as H5Dataset_realdata
from dataloader.h5dataset_fast import H5Dataset as H5DatasetFast
...
class HDF5DataLoader(DataLoader):
    ...
    def custom_collate(self, batch):
        ...
        for key, value in deepcopy(body).items():
            if key in ['inp_events', 'inp_normalized_events', 'inp_scaled_events', 'inp_pol_mask', 'gt_events', 'gt_normalized_events']:
...
class HDF5DataLoaderRealData(DataLoader):
    def __init__(self, dataloader_config):
        path_to_datalist_txt = dataloader_config['path_to_datalist_txt']
        self.dataset = concatenate_datasets(path_to_datalist_txt, H5Dataset_realdata, dataloader_config['dataset'])
        self.gt_sensor_resolution = self.dataset.datasets[0].gt_sensor_resolution
        self.inp_sensor_resolution = self.dataset.datasets[0].inp_sensor_resolution
        self.scale = dataloader_config['dataset']['scale']
...
class InferenceHDF5DataLoaderRealData(DataLoader):
    def __init__(self, data_path, dataloader_config):
        self.dataset = H5Dataset_realdata(data_path, dataloader_config['dataset'])
        self.gt_sensor_resolution = self.dataset.gt_sensor_resolution
        self.scale = dataloader_config['dataset']['scale']
...
class HDF5DataLoaderFast(DataLoader):
    def __init__(self, dataloader_config):
        path_to_datalist_txt = dataloader_config['path_to_datalist_txt']
        self.dataset = concatenate_datasets(path_to_datalist_txt, H5DatasetFast, dataloader_config['dataset'])
        self.gt_sensor_resolution = self.dataset.datasets[0].gt_sensor_resolution
        self.inp_sensor_resolution = self.dataset.datasets[0].inp_sensor_resolution
        self.scale = dataloader_config['dataset']['scale']
...
class InferenceHDF5DataLoaderFast(DataLoader):
    def __init__(self, data_path, dataloader_config):
        self.dataset = H5DatasetFast(data_path, dataloader_config['dataset'])
        self.gt_sensor_resolution = self.dataset.gt_sensor_resolution
        self.scale = dataloader_config['dataset']['scale']
