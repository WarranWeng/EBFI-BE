...
class event_visualisation():
    ...
    def plot_event_cnt(self, event_cnt, is_save, path=None, color_scheme="green_red", use_opencv=False, is_black_background=True, is_norm=True):
        """
...
def main():
    ...
    path_to_file = '/media/wwm/wwmdisk/work/dataset/Nfs/train_h5/basketball_1.h5'
...
def plot_event_3d_ori():
    ...
    path_to_file = '/media/wwm/wwmdisk/data/Nfs/train_h5/basketball_1.h5'
    dataloader = InferenceHDF5DataLoader(path_to_file, dataloader_config)
    gt_sensor_resolution = dataloader.dataset.gt_sensor_resolution
    inp_sensor_resolution = dataloader.dataset.inp_sensor_resolution
